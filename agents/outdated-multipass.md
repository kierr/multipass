...
description: "Review code for outdated patterns — deprecated APIs, superseded tooling, EOL dependencies, dead links, and vintage methodology the industry has moved on from."
