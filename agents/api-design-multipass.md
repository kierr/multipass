...
description: "Review API design quality — RESTful conventions, resource naming, pagination, idempotency, error response consistency, versioning strategy, and input/output design patterns."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - api-design-multipass
---
