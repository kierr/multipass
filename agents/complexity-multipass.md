...
description: "Review code for unnecessary complexity — over-abstraction, duplication, oversized files, speculative generality, misleading indirection. Works on diffs or full repo."
