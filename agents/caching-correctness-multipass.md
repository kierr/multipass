...
description: "Review caching correctness — invalidation logic, TTL consistency, stale reads, stampede protection, key collisions, serialization drift across HTTP, CDN, ORM, and application-level caches."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - caching-correctness-multipass
---
