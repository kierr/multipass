...
description: "Review feature flag hygiene — stale flags, flag coupling, missing removal paths, untested branches, evaluation side effects, and migration planning for flag retirement."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - feature-flags-multipass
---
