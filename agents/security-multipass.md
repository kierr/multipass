...
description: "Review security posture across trust boundaries — authn/authz, input handling, secret management, dependency exposure, and exploit paths. Includes hop-by-hop input-flow tracing from entry points to data layer."
