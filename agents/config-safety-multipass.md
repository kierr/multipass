...
description: "Review configuration behavior changes — defaults, env vars, flags, precedence, validation, reload semantics, deprecation, migration compatibility."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - config-safety-multipass
---
