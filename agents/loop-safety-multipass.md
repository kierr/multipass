...
description: "Review jobs, workers, agents, schedulers for infinite loops, runaway redrives, unchanged-input reprocessing, and missing cost/time/attempt budgets."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - loop-safety-multipass
---
