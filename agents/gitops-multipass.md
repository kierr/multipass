...
description: "Review GitOps manifests — Kustomize overlays, HelmReleases, Flux Kustomizations, OCI sources — for overlay correctness, dependency order, and secret refs."
