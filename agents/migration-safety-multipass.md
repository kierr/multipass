...
description: "Review database migration execution strategy — zero-downtime compatibility, lock risk on large tables, rollback plans, expand-contract correctness, and data migration safety."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - migration-safety-multipass
---
