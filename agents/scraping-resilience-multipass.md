...
description: "Review scrapers, crawlers, bots for fragility — site changes, anti-bot defenses, proxy exhaustion, session decay, and degradation posture."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - scraping-resilience-multipass
---
