...
description: "Gate diffs, releases, and migrations for backward-compatibility risk across APIs, CLI flags, config keys, data formats, events, and automation."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - breaking-change-multipass
---
