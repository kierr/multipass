...
description: "Review authorization models — RBAC, ABAC, IDOR, tenant isolation, privilege escalation paths, object-level vs function-level checks, and permission matrix completeness."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - access-control-multipass
---
