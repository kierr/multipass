...
description: "Review code for structural duplication — copy-paste blocks that have diverged or will diverge, near-duplicate classes, repeated validation logic, and divergent config files."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - deduplication-multipass
---
