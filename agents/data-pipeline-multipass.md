...
description: "Review multi-stage data flows where failure at stage N+1 can orphan successful work at stage N. Catches cascading partial-failure bugs."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - data-pipeline-multipass
---
