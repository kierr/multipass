...
description: "Review logs, metrics, traces, dashboards, and alerts for production detection and diagnosis signal quality without high-noise instrumentation."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - observability-multipass
---
