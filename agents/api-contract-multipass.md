...
description: "Validate externally consumed API contracts (HTTP, RPC, GraphQL, events) for compatibility and drift across handlers, schemas, tests, SDKs."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - api-contract-multipass
---
