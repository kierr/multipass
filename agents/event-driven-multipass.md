...
description: "Review event-driven and messaging systems for ordering, idempotency, DLQ handling, replay safety, schema evolution, and distributed delivery guarantees."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - event-driven-multipass
---
