...
description: "Review release processes — versioning consistency, changelog quality, deployment strategy, rollback capability, artifact signing, and tag hygiene."
