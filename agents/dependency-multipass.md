...
description: "Review dependency health — outdated, unmaintained, CVE-affected packages. Checks boundary direction, cyclic coupling, and architecture drift."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - dependency-multipass
---
