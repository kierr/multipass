...
description: "Review repository layout quality — file/directory organization, ownership boundaries, module placement, root clutter, and mixed production/test artifacts."
