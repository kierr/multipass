---
name: mise-multipass
description: "Review mise.toml configuration for correctness, task hygiene, tool pinning, source/output tracking, environment handling, and adherence to mise best practices."
