...
description: "Review type discipline across TypeScript, Python, Ruby, Go, and other typed languages — strictness gaps, unsound casts, missing narrowing, escape hatches, and type-system defeats that let runtime bugs through."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - type-safety-multipass
---
