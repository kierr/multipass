...
description: "Verify that READMEs, docs, examples, runbooks, and inline comments still match current code, config, tests, schemas, and runtime behavior."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - docs-drift-multipass
---
