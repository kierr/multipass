...
description: "Review LLM and agent systems for prompt-injection, data-exposure, and agent-safety risks across prompts, tools, RAG, memory, and model integrations."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - llm-safety-multipass
---
