...
description: "Review status fields, enum transitions, lifecycle callbacks. Catches invalid transitions race detectors miss — failed-to-succeeded jumps, orphaned claims."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - state-machine-multipass
---
