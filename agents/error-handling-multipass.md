...
description: "Review how failures travel — swallowed exceptions, inconsistent error shapes, missing retry classification, opaque error messages."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - error-handling-multipass
---
