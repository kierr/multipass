...
description: "Review provider routing, model selection, fallbacks, capability mismatches, quota handling, and cost/reliability tradeoffs."
tools: Read, Grep, Glob, Bash, LSP
model: opus
memory: project
skills:
  - model-routing-multipass
---
