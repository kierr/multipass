...
description: "Review CI/CD pipelines for cost waste — runner tier mismatches, redundant builds, low success rates, cascade failures, and trigger volume burning quota."
